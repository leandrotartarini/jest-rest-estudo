...
exports.seed = (knex) => {
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2b$10$sQD7ait/D52rUmPn0.fyWudcBWp5W6aY4SZeTzmf5APyr0OA.8FwK' },
      { id: 10001, name: 'User #2', mail: 'user2@mail.com', passwd: '$2b$10$sQD7ait/D52rUmPn0.fyWudcBWp5W6aY4SZeTzmf5APyr0OA.8FwK' }
    ]))
    ...
    .then(() => knex('transactions').insert([
      ...
      { description: 'Transfer to AccO #2', date: new Date(), ammount: -100, type: 'O', acc_id: 10002, transfer_id: 10001 },
    ]));
};
